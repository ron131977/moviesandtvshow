...
const HomePage = ({ allData }) => {
  return (
    ...
    />
        ...
        <div className="px-4 py-8 text-blue-500 text-center space-y-4 relative z-10">
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight text-shadow-lg">
            Welcome to Movies & TV Shows™
          </h1>
          <p className="text-xl md:text-2xl font-medium opacity-80 max-w-lg mx-auto">
            Online. Stream. Download. Your source for the latest updates across various categories.
          </p>
        </div>
